...
import { useLanguage } from '../contexts/CombinedContexts';
import { useTranslation } from '../lib/utils';
import { getSpaces } from '../lib/supabase';
import * as FiIcons from 'react-icons/fi';

const {
  FiSearch, FiMapPin, FiUsers, FiCalendar, FiStar, FiArrowRight,
  FiCheckCircle, FiTrendingUp, FiShield, FiClock, FiHome, FiTarget,
  FiHeart, FiAward
} = FiIcons;
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Discover and book unique event spaces for your next gathering. From corporate meetings to birthday parties, find the perfect venue on EventsySpace."
        />
        <meta
          name="keywords"
          content="event spaces, venue rental, party venues, meeting rooms, event planning"
        />
      </Helmet>
      ...
      <div className="min-h-screen">
        ...
        <section className="relative bg-gradient-to-br from-primary-600 via-primary-500 to-secondary-500 text-white overflow-hidden">
          ...
          <div
            className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1492684223066-81342ee5ff30?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80')] bg-cover bg-center opacity-30"
          ></div>
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Learn about EventsySpace's mission to connect space owners with event organizers worldwide."
        />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-primary-100 max-w-3xl mx-auto">
                We're revolutionizing how people find and book event spaces, connecting amazing venues with unforgettable experiences.
              </p>
            </motion.div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-lg text-gray-700 mb-6">
                  EventsySpace was founded with a simple yet powerful vision: to make finding and booking the perfect event space effortless for everyone. Whether you're planning an intimate gathering or a grand celebration, we believe everyone deserves access to amazing spaces.
                </p>
                <p className="text-lg text-gray-700">
                  We empower space owners to monetize their unique venues while helping event organizers discover spaces they never knew existed. It's about creating connections, fostering community, and making every event memorable.
                </p>
              </motion.div>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Our team combines expertise in technology, hospitality, and event planning to create the best possible experience for our users.
              </p>
            </div>
