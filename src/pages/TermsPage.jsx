            ...
            <div className="space-y-8">
              <section>
                ...
                <p className="text-gray-700 mb-4">
                  By accessing and using EventsySpace ("the Service"), you accept and agree to be bound by 
              ...
              <section>
                ...
                <p className="text-gray-700 mb-4">
                  EventsySpace is a platform that connects space owners ("Hosts") with individuals seeking 
                  to rent spaces for events ("Guests"). We facilitate bookings, payments, and communication 
                  between parties but are not a party to the rental agreements themselves.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-700 mb-4">
                  Cancellation policies are set by individual Hosts and vary by listing. Please review 
                  the specific cancellation policy before booking. EventsySpace may charge processing 
                  fees for cancellations as outlined in the booking confirmation.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-700 mb-4">
                  EventsySpace acts as a platform connecting Hosts and Guests. We are not responsible 
                  for the actual rental agreements, property conditions, or disputes between parties. 
